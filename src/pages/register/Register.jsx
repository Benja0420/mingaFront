      ...
      <div className='w-full lg:w-1/2'>
        <form onSubmit={registerUser} className='flex flex-col justify-center items-center gap-2 p-20 lg:p-40'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <p className="text-gray-700">Send notification to my email</p>
          </div>
          ...
          <p>Already have an account? <Link className="text-orange-600 hover:underline" to="/login">Log in</Link></p>
          <p>Go back to <Link className="text-orange-600 hover:underline" to="/">home page</Link></p>
        </form>
        </div>
